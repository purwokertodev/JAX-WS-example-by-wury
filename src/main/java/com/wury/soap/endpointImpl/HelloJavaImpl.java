...
package com.wury.soap.endpointImpl;
 ...
 * @author WURI
 */
@WebService(endpointInterface = "com.wury.soap.endpoint.HelloJava")
public class HelloJavaImpl implements HelloJava{

    @Override
    public String getHello(String yourName) {
        return "Hello JAX-WS "+yourName;
    }
